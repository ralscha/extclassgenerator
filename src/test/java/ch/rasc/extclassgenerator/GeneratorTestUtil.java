...
public class GeneratorTestUtil {
	...
	public static void testWriteModel(Class<?> clazz, String modelName) {
		try {
			...
			ModelGenerator.writeModel(new MockHttpServletRequest(), response,
					clazz, OutputFormat.EXTJS4, false);
			GeneratorTestUtil.compareExtJs4Code(modelName,
					response.getContentAsString(), false, false);

			response = new MockHttpServletResponse();
			ModelGenerator.writeModel(new MockHttpServletRequest(), response,
					clazz, OutputFormat.EXTJS5, false);
			GeneratorTestUtil.compareExtJs5Code(modelName,
					response.getContentAsString(), false, false);

			response = new MockHttpServletResponse();
			ModelGenerator.writeModel(new MockHttpServletRequest(), response,
					clazz, OutputFormat.TOUCH2, false);
			GeneratorTestUtil.compareTouch2Code(modelName,
					response.getContentAsString(), false, false);

			response = new MockHttpServletResponse();
			ModelGenerator.writeModel(new MockHttpServletRequest(), response,
					clazz, OutputFormat.EXTJS4, IncludeValidation.NONE, false);
			GeneratorTestUtil.compareExtJs4Code(modelName,
					response.getContentAsString(), false, false);

			response = new MockHttpServletResponse();
			ModelGenerator.writeModel(new MockHttpServletRequest(), response,
					clazz, OutputFormat.EXTJS5, IncludeValidation.NONE, false);
			GeneratorTestUtil.compareExtJs5Code(modelName,
					response.getContentAsString(), false, false);

			response = new MockHttpServletResponse();
			ModelGenerator.writeModel(new MockHttpServletRequest(), response,
					clazz, OutputFormat.TOUCH2, IncludeValidation.NONE, false);
			GeneratorTestUtil.compareTouch2Code(modelName,
					response.getContentAsString(), false, false);

			response = new MockHttpServletResponse();
			ModelGenerator.writeModel(new MockHttpServletRequest(), response,
					clazz, OutputFormat.EXTJS4);
			GeneratorTestUtil.compareExtJs4Code(modelName,
					response.getContentAsString(), false, false);

			response = new MockHttpServletResponse();
			ModelGenerator.writeModel(new MockHttpServletRequest(), response,
					clazz, OutputFormat.EXTJS5);
			GeneratorTestUtil.compareExtJs5Code(modelName,
					response.getContentAsString(), false, false);

			response = new MockHttpServletResponse();
			ModelGenerator.writeModel(new MockHttpServletRequest(), response,
					clazz, OutputFormat.TOUCH2);
			GeneratorTestUtil.compareTouch2Code(modelName,
					response.getContentAsString(), false, false);

			response = new MockHttpServletResponse();
			ModelGenerator.writeModel(new MockHttpServletRequest(), response,
					clazz, OutputFormat.EXTJS4, true);
			GeneratorTestUtil.compareExtJs4Code(modelName,
					response.getContentAsString(), true, false);

			response = new MockHttpServletResponse();
			ModelGenerator.writeModel(new MockHttpServletRequest(), response,
					clazz, OutputFormat.EXTJS5, true);
			GeneratorTestUtil.compareExtJs5Code(modelName,
					response.getContentAsString(), true, false);

			response = new MockHttpServletResponse();
			ModelGenerator.writeModel(new MockHttpServletRequest(), response,
					clazz, OutputFormat.TOUCH2, true);
			GeneratorTestUtil.compareTouch2Code(modelName,
					response.getContentAsString(), true, false);

			response = new MockHttpServletResponse();
			ModelGenerator.writeModel(new MockHttpServletRequest(), response,
					clazz, OutputFormat.EXTJS4, IncludeValidation.NONE, true);
			GeneratorTestUtil.compareExtJs4Code(modelName,
					response.getContentAsString(), true, false);

			response = new MockHttpServletResponse();
			ModelGenerator.writeModel(new MockHttpServletRequest(), response,
					clazz, OutputFormat.EXTJS5, IncludeValidation.NONE, true);
			GeneratorTestUtil.compareExtJs5Code(modelName,
					response.getContentAsString(), true, false);

			response = new MockHttpServletResponse();
			ModelGenerator.writeModel(new MockHttpServletRequest(), response,
					clazz, OutputFormat.TOUCH2, IncludeValidation.NONE, true);
			GeneratorTestUtil.compareTouch2Code(modelName,
					response.getContentAsString(), true, false);
	...
	public static void testWriteModelBuiltinValidation(Class<?> clazz,
			String modelName) {
		try {

			MockHttpServletResponse response = new MockHttpServletResponse();
			ModelGenerator.writeModel(new MockHttpServletRequest(), response,
					clazz, OutputFormat.EXTJS4, IncludeValidation.BUILTIN,
					false);
			GeneratorTestUtil.compareExtJs4Code(modelName,
					response.getContentAsString(), false, false);
			...
			response = new MockHttpServletResponse();
			ModelGenerator.writeModel(new MockHttpServletRequest(), response,
					clazz, OutputFormat.EXTJS5, IncludeValidation.BUILTIN,
					false);
			GeneratorTestUtil.compareExtJs5Code(modelName,
					response.getContentAsString(), false, false);
			...
			response = new MockHttpServletResponse();
			ModelGenerator.writeModel(new MockHttpServletRequest(), response,
					clazz, OutputFormat.TOUCH2, IncludeValidation.BUILTIN,
					false);
			GeneratorTestUtil.compareTouch2Code(modelName,
					response.getContentAsString(), false, false);
			...
			response = new MockHttpServletResponse();
			ModelGenerator
					.writeModel(new MockHttpServletRequest(), response, clazz,
							OutputFormat.EXTJS4, IncludeValidation.BUILTIN,
							true);
			GeneratorTestUtil.compareExtJs4Code(modelName,
					response.getContentAsString(), true, false);
			...
			ModelGenerator
					.writeModel(new MockHttpServletRequest(), response, clazz,
							OutputFormat.EXTJS5, IncludeValidation.BUILTIN,
							true);
			GeneratorTestUtil.compareExtJs5Code(modelName,
					response.getContentAsString(), true, false);
			...
			ModelGenerator
					.writeModel(new MockHttpServletRequest(), response, clazz,
							OutputFormat.TOUCH2, IncludeValidation.BUILTIN,
							true);
			GeneratorTestUtil.compareTouch2Code(modelName,
					response.getContentAsString(), true, false);
	...
	private static void testGenerateJavascript(Class<?> clazz,
			String modelName, OutputFormat outputFormat, boolean debug,
			boolean surroundApiWithQuotes, IncludeValidation includeValidation,
		...
		if (outputFormat == OutputFormat.EXTJS4) {
			GeneratorTestUtil.compareExtJs4Code(modelName,
					ModelGenerator.generateJavascript(clazz, outputConfig),
	...
	public static void testGenerateJavascript(Class<?> clazz, String modelName,
		...
		if (!useSingleQuote) {
			if (includeValidation == IncludeValidation.NONE) {
				GeneratorTestUtil.compareExtJs4Code(modelName, ModelGenerator
						.generateJavascript(clazz, OutputFormat.EXTJS4, true),
						true, false);
			}
			GeneratorTestUtil.compareExtJs4Code(modelName, ModelGenerator
					.generateJavascript(clazz, OutputFormat.EXTJS4,
							includeValidation, true), true, false);
		}
		...
		if (!useSingleQuote) {
			if (includeValidation == IncludeValidation.NONE) {
				GeneratorTestUtil.compareExtJs4Code(modelName, ModelGenerator
						.generateJavascript(clazz, OutputFormat.EXTJS4, false),
						false, false);
			}
			GeneratorTestUtil.compareExtJs4Code(modelName, ModelGenerator
					.generateJavascript(clazz, OutputFormat.EXTJS4,
							includeValidation, false), false, false);
		}
		...
		if (!useSingleQuote) {
			if (includeValidation == IncludeValidation.NONE) {
				GeneratorTestUtil.compareExtJs5Code(modelName, ModelGenerator
						.generateJavascript(clazz, OutputFormat.EXTJS5, true),
						true, false);
			}
			GeneratorTestUtil.compareExtJs5Code(modelName, ModelGenerator
					.generateJavascript(clazz, OutputFormat.EXTJS5,
							includeValidation, true), true, false);
		}
		...
		if (!useSingleQuote) {
			if (includeValidation == IncludeValidation.NONE) {
				GeneratorTestUtil.compareExtJs5Code(modelName, ModelGenerator
						.generateJavascript(clazz, OutputFormat.EXTJS5, false),
						false, false);
			}
			GeneratorTestUtil.compareExtJs5Code(modelName, ModelGenerator
					.generateJavascript(clazz, OutputFormat.EXTJS5,
		...
		if (!useSingleQuote) {
			if (includeValidation == IncludeValidation.NONE) {
				GeneratorTestUtil.compareTouch2Code(modelName, ModelGenerator
						.generateJavascript(clazz, OutputFormat.TOUCH2, true),
						true, false);
			}
			GeneratorTestUtil.compareTouch2Code(modelName, ModelGenerator
					.generateJavascript(clazz, OutputFormat.TOUCH2,
							includeValidation, true), true, false);
		}
		...
		if (!useSingleQuote) {
			if (includeValidation == IncludeValidation.NONE) {
				GeneratorTestUtil.compareTouch2Code(modelName, ModelGenerator
						.generateJavascript(clazz, OutputFormat.TOUCH2, false),
						false, false);
			}
			GeneratorTestUtil.compareTouch2Code(modelName, ModelGenerator
					.generateJavascript(clazz, OutputFormat.TOUCH2,
	...
	public static void compareExtJs4Code(String model, String value,
			boolean debug, boolean apiWithQuotes) {
		try {
	...
	public static void compareExtJs5Code(String model, String value,
			boolean debug, boolean apiWithQuotes) {
		try {
			String expectedValue = IOUtils.toString(GeneratorTestUtil.class
	...
	public static void compareTouch2Code(String model, String value,
			boolean debug, boolean apiWithQuotes) {
		try {
			String expectedValue = IOUtils.toString(GeneratorTestUtil.class
