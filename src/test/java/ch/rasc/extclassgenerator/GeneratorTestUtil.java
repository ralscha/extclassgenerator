...
public class GeneratorTestUtil {
	...
	private static void testGenerateJavascript(Class<?> clazz, String modelName, OutputFormat outputFormat,
			boolean debug, boolean surroundApiWithQuotes, IncludeValidation includeValidation, boolean useSingleQuote) {
		...
		if (outputFormat == OutputFormat.EXTJS4) {
			GeneratorTestUtil.compareExtJs4Code(modelName, ModelGenerator.generateJavascript(clazz, outputConfig),
					debug, surroundApiWithQuotes);
		} else if (outputFormat == OutputFormat.EXTJS5) {
			GeneratorTestUtil.compareExtJs5Code(modelName, ModelGenerator.generateJavascript(clazz, outputConfig),
					debug, surroundApiWithQuotes);
		} else if (outputFormat == OutputFormat.TOUCH2) {
			GeneratorTestUtil.compareTouch2Code(modelName, ModelGenerator.generateJavascript(clazz, outputConfig),
					debug, surroundApiWithQuotes);
		}
	}

	public static void testGenerateJavascript(Class<?> clazz, String modelName, boolean apiWithQuotes,
			IncludeValidation includeValidation, boolean useSingleQuote) {
		testGenerateJavascript(clazz, modelName, OutputFormat.EXTJS4, true, apiWithQuotes, includeValidation,
				useSingleQuote);
		if (!useSingleQuote) {
			if (includeValidation == IncludeValidation.NONE) {
				GeneratorTestUtil.compareExtJs4Code(modelName,
						ModelGenerator.generateJavascript(clazz, OutputFormat.EXTJS4, true), true, false);
			}
			GeneratorTestUtil
					.compareExtJs4Code(modelName,
							ModelGenerator.generateJavascript(clazz, OutputFormat.EXTJS4, includeValidation, true),
							true, false);
		}

		testGenerateJavascript(clazz, modelName, OutputFormat.EXTJS4, false, apiWithQuotes, includeValidation,
				useSingleQuote);
		if (!useSingleQuote) {
			if (includeValidation == IncludeValidation.NONE) {
				GeneratorTestUtil.compareExtJs4Code(modelName,
						ModelGenerator.generateJavascript(clazz, OutputFormat.EXTJS4, false), false, false);
			}
			GeneratorTestUtil.compareExtJs4Code(modelName,
					ModelGenerator.generateJavascript(clazz, OutputFormat.EXTJS4, includeValidation, false), false,
					false);
		}

		testGenerateJavascript(clazz, modelName, OutputFormat.EXTJS5, true, apiWithQuotes, includeValidation,
				useSingleQuote);
		if (!useSingleQuote) {
			if (includeValidation == IncludeValidation.NONE) {
				GeneratorTestUtil.compareExtJs5Code(modelName,
						ModelGenerator.generateJavascript(clazz, OutputFormat.EXTJS5, true), true, false);
			}
			GeneratorTestUtil
					.compareExtJs5Code(modelName,
							ModelGenerator.generateJavascript(clazz, OutputFormat.EXTJS5, includeValidation, true),
							true, false);
		}

		testGenerateJavascript(clazz, modelName, OutputFormat.EXTJS5, false, apiWithQuotes, includeValidation,
				useSingleQuote);
		if (!useSingleQuote) {
			if (includeValidation == IncludeValidation.NONE) {
				GeneratorTestUtil.compareExtJs5Code(modelName,
						ModelGenerator.generateJavascript(clazz, OutputFormat.EXTJS5, false), false, false);
			}
			GeneratorTestUtil.compareExtJs5Code(modelName,
					ModelGenerator.generateJavascript(clazz, OutputFormat.EXTJS5, includeValidation, false), false,
					false);
		}

		testGenerateJavascript(clazz, modelName, OutputFormat.TOUCH2, true, apiWithQuotes, includeValidation,
				useSingleQuote);
		if (!useSingleQuote) {
			if (includeValidation == IncludeValidation.NONE) {
				GeneratorTestUtil.compareTouch2Code(modelName,
						ModelGenerator.generateJavascript(clazz, OutputFormat.TOUCH2, true), true, false);
			}
			GeneratorTestUtil
					.compareTouch2Code(modelName,
							ModelGenerator.generateJavascript(clazz, OutputFormat.TOUCH2, includeValidation, true),
							true, false);
		}

		testGenerateJavascript(clazz, modelName, OutputFormat.TOUCH2, false, apiWithQuotes, includeValidation,
				useSingleQuote);
		if (!useSingleQuote) {
			if (includeValidation == IncludeValidation.NONE) {
				GeneratorTestUtil.compareTouch2Code(modelName,
						ModelGenerator.generateJavascript(clazz, OutputFormat.TOUCH2, false), false, false);
			}
			GeneratorTestUtil.compareTouch2Code(modelName,
					ModelGenerator.generateJavascript(clazz, OutputFormat.TOUCH2, includeValidation, false), false,
					false);
		}
	}
	...
	public static void compareExtJs5Code(String model, String value, boolean debug, boolean apiWithQuotes) {
		try {
			String expectedValue = IOUtils.toString(GeneratorTestUtil.class.getResourceAsStream("/generator/" + model
