...
public class ModelGeneratorBeanWithValidationTest {
	...
	public void testCreateModel() {
		...
		assertThat(modelBean.getValidations().get(7)).isInstanceOf(RangeValidation.class);
		...
		assertThat(modelBean.getValidations().get(8)).isInstanceOf(DigitsValidation.class);
		DigitsValidation digitsValidation = (DigitsValidation) modelBean.getValidations().get(8);
		...
		assertThat(modelBean.getValidations().get(9)).isInstanceOf(FutureValidation.class);
		assertThat(modelBean.getValidations().get(9).getType()).isEqualTo("future");
		assertThat(modelBean.getValidations().get(9).getField()).isEqualTo("future");

		assertThat(modelBean.getValidations().get(10)).isInstanceOf(PastValidation.class);
		...
		assertThat(modelBean.getValidations().get(11)).isInstanceOf(NotBlankValidation.class);
		...
		assertThat(modelBean.getValidations().get(12)).isInstanceOf(CreditCardNumberValidation.class);
		assertThat(modelBean.getValidations().get(12).getType()).isEqualTo("creditCardNumber");
		assertThat(modelBean.getValidations().get(12).getField()).isEqualTo("creditCardNumber");
