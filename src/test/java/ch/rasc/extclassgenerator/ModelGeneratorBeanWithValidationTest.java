...
public class ModelGeneratorBeanWithValidationTest {
	...
	public void testWriteModelHttpServletRequestHttpServletResponseClassOfQOutputFormatBoolean()
		...
		ModelGenerator.writeModel(new MockHttpServletRequest(), response,
				BeanWithValidation.class, OutputFormat.EXTJS4, IncludeValidation.ALL,
				true);
		...
		ModelGenerator.writeModel(new MockHttpServletRequest(), response,
				BeanWithValidation.class, OutputFormat.TOUCH2, IncludeValidation.ALL,
				false);
	...
	public void testCreateModel() {
		ModelBean modelBean = ModelGenerator.createModel(BeanWithValidation.class,
				IncludeValidation.ALL);
		...
		EmailValidation emailValidation = (EmailValidation) modelBean.getValidations()
				.get(1);
		...
		RangeValidation rangeValidation = (RangeValidation) modelBean.getValidations()
				.get(3);
		...
		assertThat(modelBean.getValidations().get(8))
				.isInstanceOf(DigitsValidation.class);
		DigitsValidation digitsValidation = (DigitsValidation) modelBean.getValidations()
				.get(8);
		...
		assertThat(modelBean.getValidations().get(9))
				.isInstanceOf(FutureValidation.class);
