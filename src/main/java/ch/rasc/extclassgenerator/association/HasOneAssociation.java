...
public class HasOneAssociation extends AbstractAssociation {
	...
	/**
	 * Creates an instance of a hasOne association. Sets {@link #model} to the provided parameters.
	 *
	...
	/**
	 * Creates an instance of a hasOne association. Sets {@link #model} to the full qualified name of the model class or
	 * the string from {@link Model#value()} if present on the class.
	 *
	 ...
	 * <p>
	 * Corresponds to the <a href= "http://docs.sencha.com/ext-js/4-2/#!/api/Ext.data.association.HasOne-cfg-setterName"
	 ...
	 * <p>
	 * Corresponds to the <a href= "http://docs.sencha.com/ext-js/4-2/#!/api/Ext.data.association.HasOne-cfg-getterName"
